        ...
        <div className="grid bg-slate-50 sm:px-6 sm:pb-16 md:grid-cols-2 md:rounded-3xl md:px-8 md:pt-16 lg:p-20">
            <div className="flex flex-col px-4 py-16 sm:px-10 md:py-12 lg:px-12">
                <div className="flex">
                    ...
                    <p className="text-slate-900 text-7xl ml-1 mt-1 font-bold">39</p>
                </div>
                ...
                <ul className="mt-8 divide-y divide-slate-200">
                    <li className="flex py-2">
                        <svg aria-hidden="true" className="flex-none w-8 h-8 fill-blue-600">
            ...
            <div className="flex flex-col bg-blue-600 px-4 py-16 sm:rounded-3xl sm:px-10 md:py-12 lg:px-12">
                <div className="flex">
