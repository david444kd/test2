      ...
      <div className="bg-slate-50 p-5 sm:p-20 rounded-3xl">
        ...
        <div className="mt-8">
          <h1 className="text-5xl sm:text-5xl font-extrabold text-slate-900 tracking-tight font-serif">
            <span className="text-blue-600">Yunus Erturk –</span>
            Hey there, I’m the author behind ‘Get Your First Client’.
          </h1>
        </div>
        <div className="mt-4">
          <p className="text-slate-700 text-lg">
            I’m a UI designer and developer in NY. <br />
            I’ve been working in the industry for 10+ years. I’ve worked as a
            freelancer, in agencies, and in-house. I experienced the good and
            the bad sides of the freelance life. During this time, I talked to
            many freelancers and saw the pain points of freelancing. Those who
            want to work freelance are most stuck on finding the first customer.
            But most don’t make it with a plan and a strategy. And I made this
            guide to help you get started. Please let me know if you have any
            questions. I’m always happy to help. Follow me on Twitter for more
            updates.
          </p>
        </div>
        <div className="mt-8 flex items-center">
          <svg className="fill-blue-600 w-10 h-10">
