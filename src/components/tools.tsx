  ...
  return (
    <div className="mb-16">
      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:max-w-4xl lg:px-12">
          ...
          <div className="mt-8">
              <h1 className="text-3xl font-bold text-slate-900 tracking-tight font-serif">Pre-made tools and templates to help you get started</h1>
          </div>
          <div className="mt-4">
              <p className="text-slate-700 text-lg">I created a few tools and templates to help you get started freelancing.
              </p>
          </div>
      </div>
      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:max-w-7xl lg:px-8 mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-8">
            ...
            <div className="mt-8">
                <img className="shadow-lg rounded-xl" src="https://getyourfirstclient.freelancerpath.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcontract.1b086f9c.png&w=828&q=75" alt="" />
            ...
            <div className="mt-8">
                <img className="shadow-lg rounded-xl" src="https://getyourfirstclient.freelancerpath.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Finvoice.52baa94c.png&w=828&q=75" alt="" />
                <h3 className="text-slate-500 font-mono mb-2 text-sm mt-8">03</h3>
                <h2 className="text-slate-900 font-medium">Invoice Management System and Invoice Template</h2>
            ...
            <div className="mt-8">
                <img className="shadow-lg rounded-xl" src="https://getyourfirstclient.freelancerpath.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fproject.841bf686.png&w=828&q=75" alt="" />
                <h3 className="text-slate-500 font-mono mb-2 text-sm mt-8">04</h3>
                <h2 className="text-slate-900 font-medium">Project Management System</h2>
            ...
            <div className="mt-8">
                <img className="shadow-lg rounded-xl" src="https://getyourfirstclient.freelancerpath.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcustomer.b32762bd.png&w=828&q=75" alt="" />
                <h3 className="text-slate-500 font-mono mb-2 text-sm mt-8">05</h3>
                <h2 className="text-slate-900 font-medium">Customer Management System - a basic CRM</h2>
            ...
            <div className="mt-8">
                <img className="shadow-lg rounded-xl" src="https://getyourfirstclient.freelancerpath.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fongoing.5c6d364c.png&w=828&q=75" alt="" />
                <h3 className="text-slate-500 font-mono mb-2 text-sm mt-8">06</h3>
                <h2 className="text-slate-900 font-medium">Ongoing Support and New Tools</h2>
