  ...
  return (
    <div className="bg-blue-600 px-4 py-20 gap-y-12  xl:py-32 w-full relative items-end grid grid-cols-1 lg:grid-cols-2 mt-14 sm:px-10 md:px-40 lg:px-80">
        ...
        <div className="lg:pl-16">
            ...
            <form className="border-1 border-white grid grid-cols-2 rounded-xl mt-5">
                <input type="email" required placeholder="Email address" className="w-full bg-blue-600 px-1 py-2 text-white focus:outline-none m-2" />
                <Button color="primary" type="submit" className="bg-white text-blue-600 hover:text-blue-700 active:bg-blue-50 m-2">
                    Get free tool
                </Button>
            </form>
        </div>
